...
export class AbmPeliculasComponent implements OnInit 
{
  ...
  public registrar(): void
  {
    ...
    if(this.formRegistro.valid)
    {
      ...
      this.peliculasService.AgregarPelicula(new Pelicula(this.formRegistro.value.nombre, this.formRegistro.value.apellido, this.formRegistro.value.nacionalidad, this.formRegistro.value.fecha));
